...
import {Nav,Navbar,NavbarBrand,Jumbotron, NavItem, NavbarToggler, Modal, Button, ModalHeader,
     ModalBody, Label, Input, Form, FormGroup} from 'reactstrap';
            ...
            <Navbar dark expand="md">
                <div className="container">
                    ...
                    <Nav className="ml-auto" navbar>
                        <NavItem>
                            <Button color='warning' outline onClick={this.toggleModal}><span className="fa fa-sign-in fa-lg"></span> Login</Button>
                        </NavItem>
                    </Nav>
                    </Collapse>
                </div>    
